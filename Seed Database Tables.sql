...
BEGIN
	...
	VALUES
		(1,'Pro1Optimization',1,1),
		(2,'Pro1Optimization\AprilRelease',1,2),
		(3,'Pro1Optimization\MarchRelease',1,3),
		(4,'Pro1Optimization\JanuaryRelease',1,4),
		(5,'Pro1Optimization\Beta',1,5),
		(6,'Pro1Optimization\Alpha',1,6),
		(7,'Pro1CleaningTool',2,7),
		(8,'Pro1CleaningTool\SeptemberRelease',2,8),
		(9,'StreamFlow\Beta',3,9),
		(10,'StreamFlow\Alpha',3,10),
		(11,'Cinder\TestRelease',4,11)
	...
	VALUES
		(1,2966,'Tool: Error "Could not load file or assembly" on analyze',1,1,1,0,CONVERT(datetime, 'Aug 22 2018 08:09:24'),NULL,NULL,1,2,NULL,2,NULL),
		(1,2955,'Pro1 Tool: Tool does not find all items of Customer by CustomerID',2,1,1,0,CONVERT(datetime, 'Aug 16 2018 10:40:15'),NULL,NULL,1,2,NULL,2,2723),
		(2,1653,'submit feed',2,2,2,0,CONVERT(datetime, 'Mar 23 2017 12:18:48'),4,CONVERT(datetime, 'Apr 10 2018 06:57:57'),3,2,'two different submits:&nbsp;<div><br></div><div>fist, submit FBM (optimizing Pro1 S) - used to get statistics . THis one creates new SKUs and allows to get dashboard report (that has traffic and other KPIs)</div><div><br></div><div><br></div><div>the first one is under type&nbsp;<span style="color:rgb(0, 0, 0);font-family:verdana, arial, helvetica, sans-serif;font-size:12px;font-weight:bold;">Product Feed</span></div><span style="color:rgb(0, 0, 0);font-family:verdana, arial, helvetica, sans-serif;font-size:12px;"></span><p class=p style="padding:0px;margin-top:8px;margin-bottom:8px;color:rgb(0, 0, 0);font-family:verdana, arial, helvetica, sans-serif;font-size:12px;">Enumeration value:&nbsp;<samp class="ph codeph" style="padding:0px;margin:0px;font-family:&quot;Courier New&quot;, Courier, monospace;">_POST_PRODUCT_DATA_</samp></p><p class=p style="padding:0px;margin-top:8px;margin-bottom:8px;"><font color="#000000" face="verdana, arial, helvetica, sans-serif">http://docs.developer.amazonservices.com/en_US/feeds/Feeds_FeedType.html</font></p><div>second, submit FBA - to put those items that have the best KPI for sale , here we need to remap them into Pro1 s that are fulfilled by Amazon.</div><div><br></div><div>Supposedly,&nbsp;<span style="font-size:12px;color:rgb(0, 0, 0);font-family:verdana, arial, helvetica, sans-serif;">Enumeration value:&nbsp;</span><samp class="ph codeph" style="font-size:12px;padding:0px;margin:0px;font-family:&quot;Courier New&quot;, Courier, monospace;color:rgb(0, 0, 0);">_POST_PRODUCT_OVERRIDES_DATA_ (<span style="font-weight:bold;">needs more research by Valera)</span></samp></div><div>Trigger the email to Amazon to remap the listing.( related task)</div><div><br></div><div>optionally -&nbsp;<span style="color:rgb(0, 0, 0);font-family:verdana, arial, helvetica, sans-serif;font-size:12px;font-weight:bold;">Inventory Feed</span></div><span style="color:rgb(0, 0, 0);font-family:verdana, arial, helvetica, sans-serif;font-size:12px;"></span><p class=p style="padding:0px;margin-top:8px;margin-bottom:8px;color:rgb(0, 0, 0);font-family:verdana, arial, helvetica, sans-serif;font-size:12px;">Enumeration value:&nbsp;<samp class="ph codeph" style="padding:0px;margin:0px;font-family:&quot;Courier New&quot;, Courier, monospace;">_POST_INVENTORY_AVAILABILITY_DATA_</samp></p><div><br></div><div><br></div><div>http://docs.developer.amazonservices.com/en_US/feeds/Feeds_SubmitFeed.html</div><div><br></div><div>It is done only upon internally we mapped the SKUs</div><div><div><br></div><div><br></div></div>',3,NULL),
		(1,1952,'Pro1 Optimization Tool: Pro1 Remaping. Wrong sorting in columns in Pro1 Remaping',3,1,1,0,CONVERT(datetime, 'Jun 14 2017 09:09:57'),NULL,NULL,1,2,NULL,1,NULL),
		(2,2723,'Pro1 Tool: separate search history for a certain search type',3,1,1,0,CONVERT(datetime, 'Apr 05 2018 07:35:38'),NULL,NULL,1,2,NULL,3,NULL),
		(1,2724,'Pro1 Tool: Search label text cuts on search cancel',3,1,1,0,CONVERT(datetime, 'Apr 05 2018 07:42:59'),NULL,NULL,1,2,NULL,1,2723),
		(1,2725,'Pro1 Tool: label text is not complete or comprehensive',3,1,1,0,CONVERT(datetime, 'Apr 05 2018 07:42:59'),NULL,NULL,1,2,NULL,2,2723),
		(1,2734,'Pro1 Tool: Pro1 doesn`t delete from database after deleting a single item in feed',3,1,1,0,CONVERT(datetime, 'Apr 10 2018 06:11:25'),NULL,NULL,1,2,NULL,2,NULL),
		(1,2727,'Pro1 Tool: Id is 0 in generated csv file',3,2,2,3,CONVERT(datetime, 'Apr 06 2018 06:57:57'),4,CONVERT(datetime, 'Apr 10 2018 06:57:57'),3,2,NULL,2,NULL),
		(2,2782,'Roll back the last update with database fix',3,1,1,1,CONVERT(datetime, 'May 28 2018 08:28:53'),NULL,NULL,1,2,'delete new code that touched old/new database compatibility <br>',3,NULL),
		(3,2769,'Deployment',3,2,2,0,CONVERT(datetime, 'Apr 06 2018 06:57:57'),4,CONVERT(datetime, 'Apr 15 2018 06:57:57'),1,2,NULL,3,NULL),
		(1,1803,'Pro1 Optimization Tool: Missing a App icon',3,1,1,0,CONVERT(datetime, 'Apr 26 2017 07:28:37'),NULL,NULL,1,2,NULL,1,NULL),
		(1,1970,'Color lookup should match entire color value',3,3,1,0,CONVERT(datetime, 'Jul 06 2017 09:31:16'),NULL,NULL,1,2,NULL,1,NULL)
